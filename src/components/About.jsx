...
const About = () => {
  return (
    <div
      name="About"
      className="flex flex-col lg:flex-row items-center justify-center mt-10 xl:mx-[10%] xl:mt-20 text-[#CCC8BD] gap-5 mx-10"
    >
      <div className="relative ">
        <div className="relative h-[200px] w-[150px] md:h-[400px] md:w-[350px] lg:h-[600px] lg:w-[400px] xl:h-[700px] xl:w-[550px] group">
          <img
            src={prof1}
            alt="prof1"
            className="absolute h-[200px] w-[150px] md:h-[400px] md:w-[350px] lg:h-[600px] lg:w-[400px] xl:h-[600px] xl:w-[550px] group-hover:skew-x-[80deg]  group-hover:-translate-x-[79px] group-hover:h-[20px] group-hover:mt-[180px] md:group-hover:skew-x-[80deg]  md:group-hover:-translate-x-[90px] md:group-hover:h-[20px] md:group-hover:mt-[380px] lg:group-hover:skew-x-[85deg] lg:group-hover:-translate-x-[200px] lg:group-hover:h-[20px] lg:group-hover:mt-[580px] duration-200 rounded-3xl object-cover"
          />
          <img
            src={prof1nbg}
            alt="prof1nbg"
            className="absolute h-[200px] w-[150px] md:h-[400px] md:w-[350px] lg:h-[600px] lg:w-[400px] xl:h-[600px] xl:w-[550px] object-cover"
          />
        </div>
      </div>
